...
public class GaoDeActivity extends AppCompatActivity implements LocationSource, AMapLocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myLocationStyle.myLocationIcon( BitmapDescriptorFactory.fromResource(R.drawable.mapbtn_listen48));
    ...
    public void onLocationChanged(AMapLocation amapLocation) {
        ...
        if (amapLocation != null) {
            if (amapLocation.getErrorCode() == 0) {
                ...
                Toast.makeText(getApplicationContext(), R.string.Failed_to_locate, Toast.LENGTH_LONG).show();
            }
        }
    }
